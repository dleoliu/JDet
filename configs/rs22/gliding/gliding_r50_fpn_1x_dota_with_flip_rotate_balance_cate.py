...
model = dict(
    ...
    bbox_head=dict(
        ...
        pooler_resolution=7,
        pooler_scales=[1 / 4.0, 1 / 8.0, 1 / 16.0, 1 / 32.0, 1 / 64.0],
        ...
        bbox_loss=dict(type="SmoothL1Loss", beta=1.0, loss_weight=1.0),
        fix_loss=dict(
            type="SmoothL1Loss",
            beta=1.0 / 3.0,
            loss_weight=1.0,
        ),
        ratio_loss=dict(type="SmoothL1Loss", beta=1.0 / 3.0, loss_weight=16.0),
        with_bbox=True,
...
dataset = dict(
    train=dict(
        ...
        transforms=[
            dict(type="RotatedResize", min_size=1024, max_size=1024),
